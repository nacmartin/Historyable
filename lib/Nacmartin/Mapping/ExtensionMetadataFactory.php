...
use Nacmartin\Mapping\Driver\File as FileDriver;
...
final class ExtensionMetadataFactory
{
     ...
     * @return Nacmartin\Mapping\Driver
     */
    private function getDriver($omDriver)
    {
        ...
        if ($driverName == 'DriverChain') {
            ...
            if (!class_exists($driverClassName)) {
                ...
                if (!class_exists($driverClassName)) {
                    throw new \Nacmartin\Exception\RuntimeException("Failed to fallback to annotation driver: ({$driverClassName}), extension driver was not found.");
                }
            }
